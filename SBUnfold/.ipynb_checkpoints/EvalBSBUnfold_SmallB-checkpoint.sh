...
srun python sample.py --n-gpu-per-node 1  --sample-name 'OmniFold_train_small.h5'  --ckpt 'BSBUnfold_OmniFold_train_small_KL1fix_iter10M_4x45_SelfCond' --batch-size 100000 --save-target '/global/cfs/projectdirs/m3246/sdiefenbacher/Schroedinger_Bridge/SBUnfold_results/BSBUnfold' --n-ensemble 50 --n-ensemble-start 25 --n-eval 5309543 --hidden-dim 45 --nresnet 4
