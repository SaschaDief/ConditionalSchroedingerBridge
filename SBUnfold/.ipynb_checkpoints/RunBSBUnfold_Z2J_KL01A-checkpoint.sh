...
srun python train_physics.py --corrupt 'BSBU_Z2Jet_KL01_i500k_Bmin1e7_lr1e3_4x3x512_SC' --n-gpu-per-node 1 --beta-max 0.1 --beta-min 1e-7 --sample-name 'Z_2j' --num-itr 500000 --kl 0.1 --cond-x1 --lr 1e-3 --hidden-dim 512 --nresnet 4 --layerresnet 3

srun python sample.py --n-gpu-per-node 1  --sample-name 'Z_2j'  --ckpt 'BSBU_Z2Jet_KL01_i500k_Bmin1e7_lr1e3_4x3x512_SC' --batch-size 50000 --save-target '/global/cfs/projectdirs/m3246/sdiefenbacher/Schroedinger_Bridge/SBUnfold_results/BSBUnfold/Z_2Jet' --n-ensemble 1 --n-ensemble-start 0 --n-eval 600000 --hidden-dim 512 --nresnet 4 --layerresnet 3 --bnn-map
...
#python plot_ensembleZ2Jet.py --sample-name 'Z_2j' --data-name 'BSBU_Z2Jet_KL01_i5M_Bmin1e6_lr1e3_4x3x512_SC' --directory '/global/cfs/projectdirs/m3246/sdiefenbacher/Schroedinger_Bridge/SBUnfold_results/BSBUnfold/Z_2Jet'